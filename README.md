...
|-------|------------|--------|
| **Phase 1** 🐧 Linux Administration & Troubleshooting | `linux-administration-lab` [Open Repository]([https://github.com/username/devsecops-lab](https://github.com/Omniaibrahim93/Linux-Troubleshooting)  | 🔨 In Progress |
